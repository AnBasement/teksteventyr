...
- Oppretter en GitHub Action for automatisering av releases.

### Endret

- Fikser formatteringen i `ENDRINGSLOGG.md`.

### Fikset

- Manglende komma i dicten for koblinger i kjelleren i `kartdata.py`.
